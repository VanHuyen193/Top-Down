...
[CreateAssetMenu(fileName = "Character Data", menuName = "2D Top-down/Character Data")]
public class CharacterData : ScriptableObject
{
    ...
    {
        maxHealth = 100, moveSpeed = 1, might = 1,
        amount = 0, area = 1, speed = 1, 
        duration = 1, cooldown = 1, luck = 1,
        greed = 1, growth = 1, curse = 1
    };
}
